...
namespace Activity_01_Lab
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'customerDB1DataSet.Table_1' table. You can move, or remove it, as needed.
            this.table_1TableAdapter.Fill(this.customerDB1DataSet.Table_1);
            loadCustomer();
        ...
        private void loadCustomer()
        {
            try
            {
                string strconnection = "Data Source=MUHAMMAD-MAAUZ\\SQLEXPRESS;Initial Catalog=CustomerDB1;Integrated Security=True;";
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            if (form_data_validation())
            {
                try
                {
                    ...
                    string strcommand = $"INSERT INTO Customer VALUES {txt_cname.Text},{combo_country.Text},{Gender},{Hobby},{status}";
                    SqlCommand objCommand = new SqlCommand(strcommand, objconnection);
